...
- **Drivers** can be located in the [web drivers](./webDrivers) folder, move the driver you require to the main directory. The code currently uses the chrome driver so make sure you change that before running the file if you plan to use a different driver
